...
class Tneuqole {
    ...
    async save() {
        if (this.columns === undefined) throw new Error("Columns not defined: this.columns is undefined");
        ...
        let insertIds = await this.newQuery().insert(values);
